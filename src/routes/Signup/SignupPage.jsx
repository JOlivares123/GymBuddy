        ...
        <>
            ...
            <form className='me-auto ms-auto col-7 mt-4 text-start'>
                <div className="mb-3">
                    ...
                    <input type="firstName" className="form-control TransparentInput white" id="firstName" aria-describedby="firstNameHelp"/>
                </div>
                <div className="mb-3">
                    <label htmlFor="lastName" className="form-label">Last Name <span style={{color: 'red'}}>*</span></label>
                    <input type="lastName" className="form-control TransparentInput white" id="lastName" aria-describedby="lastNameHelp"/>
                </div>
                <div className="mb-3">
